    ...
    return (
        <div className="contact-container">
            ...
            <div className="item links-container">
                ...
                <a href="https://drive.google.com/file/d/128y1f6NLKJVZtlFNlOJ4H0x5WNZmahMv/view?usp=sharing" target="_blank" rel="noopener noreferrer"><img className="icon-img resume" src={require('../images/icons/003-cv.png')} alt="Resume" /></a>
            </div>
